...
- Auth: page loads use `requirePage('/path')` (session + view gate); admin pages also gate in the page + RLS. Mutations call `requireCap(href, 'create'|'edit')` from `lib/access.js`.
